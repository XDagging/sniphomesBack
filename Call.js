...
`;
    ...
    async processResponse(geminiResponse) {
        try {
            ...
            if (this.customerName && this.vehicleModel && this.customerEmail && this.paymentMethod && this.customerName !== "unknown" && this.customerEmail !== "unknown" && this.vehicleModel !== "unknown" && this.paymentMethod !== "unknown" && this.appointmentTime && this.appointmentTime !== "NOT_SET") {
